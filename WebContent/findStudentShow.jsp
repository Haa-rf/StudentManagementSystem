    ...
    <div class="xt-table">
    	...
    	ArrayList students =(ArrayList) request.getAttribute("students");
   		for(int i=0;i<students.size();i++){
   			...
   			%>
               <tr>
                   <td><% out.print(student.getStudent_id()); %></td>
                   <td><% out.print(student.getStudent_name()); %></td>
                   <td><% out.print(student.getStudent_password()); %></td>
                   <td><% out.print(student.getStudent_sex()); %></td>
                   <td><% out.print(student.getStudent_birthday()); %></td>
                   <td><% out.print(student.getStudent_telephone()); %></td>
                   <td><% out.print(student.getStudent_email()); %></td>
                   <td><% out.print(student.getStudent_address()); %></td>
                   <td><% out.print(student.getStudent_department()); %></td>
                   <td><a href="updateStudent.jsp?stu_id=<%=student.getStudent_id()%>" class="yellow-xt">Modify</a><a href="DeleteServlet?stu_id=<%=student.getStudent_id()%>" class="red-xt">Delete</a></td>
               </tr>
    	<%	
    	}
    	%>	
