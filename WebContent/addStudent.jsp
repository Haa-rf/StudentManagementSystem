...
<div id="xt-right">
    ...
    <div class="xt-table">
        <table cellpadding="0" cellspacing="0" border="0" bgcolor="#dcdcdc" width="100%">
            ...
            <tr>
                <td><input style="width:100px" type="text" name="student_id" ></td>
              	<td><input style="width:60px" type="text" name="student_name"></td>
              	<td><input style="width:100px" type="text" name="student_password" ></td>
              	<td><input style="width:40px" type="text" name="student_sex" ></td>
              	<td><input style="width:100px" type="text" name="student_birthday" ></td>
              	<td><input style="width:100px" type="text" name="student_telephone" ></td>
              	<td><input style="width:100px" type="text" name="student_email" ></td>
              	<td><input style="width:100px" type="text" name="student_address" ></td>
              	<td><input style="width:100px" type="text" name="student_department" ></td>
